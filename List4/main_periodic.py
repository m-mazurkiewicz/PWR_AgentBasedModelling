...
from schelling_segregation import GridPeriodic
...
file_name = sys.argv[8]+'_periodic_'+('_').join(sys.argv[1:8])

grid = GridPeriodic(num_of_type_0, num_of_type_1, num_neighbors_0, num_neighbors_1, staying_threshold_0, staying_threshold_1)
