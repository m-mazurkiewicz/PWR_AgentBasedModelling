...
def calculate_threshold_for_different_densities(lowest_density=.2, highest_density=.7, number_of_densities_to_check=50, width=20, height=20):
...
def plot_thresholds(dict_of_thresholds):
    ...
    plt.plot(x, y)
    #plt.savefig('percolation100.png')
    plt.show()